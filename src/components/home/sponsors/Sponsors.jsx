...
const Sponsors = () => {
  ...
  return (
    <div ref={sponsorsRef} className='min-h-screen w-full flex flex-col justify-center items-center text-4xl font-bold'>
        <h2 className={`mb-5 ${sponsorsIsVisible ? 'animate-rightappear' : ''}`}>Sponsorlar</h2>
        <div className={`flex items-center ${sponsorsIsVisible ? 'animate-bottomappear' : ''}`}>
